...
import com.rocky.arouter_api.core.ARouterLoadGroup;
import com.rocky.arouter_api.core.ARouterLoadPath;
import com.rocky.arouter_api.core.Call;
...
public final class RouterManager {
    ...
    private RouterManager() {
        // 初始化，并赋值缓存中条目的最大值（最多183组）
        groupCache = new LruCache<>(183);
        // 每组最多183条路径值
        pathCache = new LruCache<>(183);
    }
    ...
    public Object navigation(Context context, BundleManager bundleManager, int code) {
        ...
        try {
            ...
            if (pathLoad == null) {
                Class<? extends ARouterLoadPath> clazz = groupLoad.loadGroup().get(path);
                if (clazz != null) {
